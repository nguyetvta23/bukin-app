...
const Footer = () => {
    ...
    const Company = 'FocusFlow Co.LTD';
  return (
    <>
      <footer className="bg-gray-800 dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              <Image src={logo} alt='#' className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-gray-300" />
          ...
          <div className="px-4 py-6 bg-gray-800 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-300 dark:text-gray-300 sm:text-center">
              © {currentYear} <a href="#">{Company}</a>. All Rights
              Reserved.
            </span>
